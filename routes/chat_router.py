...
from database.mongo_services import create_conversation, add_message, get_history, chat_collection
import openai
...
async def chat(msg: MessageRequest):
    ...
    add_message(msg.conversation_id, msg.text, reply)  # truyền conversation_id
